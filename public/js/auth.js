// public/js/auth.js — HappyDate Auth (Supabase v2, for static HTML pages)
...
async function signInWithProvider(provider="google", options={}){
  ...
  if (error) { toast("Nie udało się rozpocząć logowania OAuth.", "error"); throw error; }
}
...
async function signOut(){
  try {
    ...
    console.error(e); toast("Błąd wylogowania", "error");
  }
}
